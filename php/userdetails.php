    ...
    <div class="container-fluid">
        ...
        <form method="post" name="tcredit" class="tabletext"><br>
            ...
            <div class="text-center">
                <button class="btn mt-3 waves-effect black" name="submit" type="submit" id="myBtn">Transfer</button>
            </div>
            <br>
        </form>
    </div>
...
if (isset($_POST['submit'])) {
    ...
    if (($amount) < 0) {
        echo '<script>';
        echo ' alert("Please enter right amount.")';  // showing an alert box.
        echo '</script>';
    }
